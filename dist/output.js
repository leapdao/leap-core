  ...
  /* eslint-disable class-methods-use-this */(0, _createClass3.default)(Output, [{ key: 'getSize', value: function getSize()
...

    {
      ...
      return dataBuf;
                                                                                                                                                 ...
                                                                                                                                                 *                            2 is comp response
                                                                                                                                                 * @returns {Output}
                                                                                                                                                 */ }, { key: 'fromRaw', value: function fromRaw(buf) {var offset = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;var isComp = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;var value = (0, _util.readUint64)(buf, offset); // computation request output

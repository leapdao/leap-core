...
export default class Transaction {
  ...
  */
  ...
  getConditionSig(privKey) {
    ...
    ethUtil.ripemd160(noSigs).copy(sigHash, 12, 0, 20);
  ...
  signWeb3(web3, accountIndex = 0) {
    ...
    return Transaction.signHashWeb3(web3, this.sigData(), accountIndex)
      .then(({ r, s, v, signer }) => {

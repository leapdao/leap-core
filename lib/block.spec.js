...
describe('blocks', () => {
  ...
  it('should allow to create block with transfer.', (done) => {
    ...
    expect(block.merkleRoot()).to.eql('0x314eb222319483fbe7dc1e7c2a05e708a519ebfc8ba26c3f8b4c1e0c2017613c');
    // test hashing
    expect(block.hash()).to.eql('0xa8e24e5fc84d0c339df63de5d69c32ce5351c8cd9e44df25b335e7512bc3c322');

    // create proof

    const proof = block.proof(transfer);
    expect(proof).to.eql([
      '0x314eb222319483fbe7dc1e7c2a05e708a519ebfc8ba26c3f8b4c1e0c2017613c',
      ...
      '0x7761732066756e2100c3aa9c73dfaab2802c598b08481dd851dcde7eca6e2531',
      '0x08805a2f5ac451378f09c9289eda3e730ea897b361afa8bbd37d9c0693d10578',
      '0x645cf2c77138b783131b00000000000000000000000000000000000000000000',
  ...
  it('should allow to create block with multiple transactions.', () => {
    ...
    expect(block.merkleRoot()).to.eql('0x205edb83a1c3479cd5aba233d12d69a7dd3b7da721d2d071e8d601f636b64708');
  });

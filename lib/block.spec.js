...
describe('blocks', () => {
  it('should allow to create and sign block with coinbase.', (done) => {
    ...
    expect(proof).to.eql([
      ...
      '0x0000001d000000001c0000000000000000000000000000000000000000000000',
  ...
  it('should allow to create and sign block with deposit.', (done) => {
    ...
    expect(proof).to.eql([
      ...
      '0x00000021000000001c0000000000000000000000000000000000000000000002',
  ...
  it('should allow to create and sign block with transfer.', (done) => {
    ...
    expect(proof).to.eql([
      ...
      '0x00000088000000001b0000000000000000000000000000000300000000000000',

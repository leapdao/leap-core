...
describe('transactions', () => {
  ...
  it('signCondition/getConditionSigners should work as expected', () => {
    ...
    condition.inputs[0].setMsgData('0xabcdef');
    condition.signCondition(PRIV);
    condition.signCondition(PRIV2);

    const signers = condition.getConditionSigners();

    assert.deepEqual(
      signers,
      [
        '0x16530effa38d23fd030971b9ab809fc235b8959d',
        '0x82e8c6cf42c8d1ff9594b17a3f50e94a12cc860f',
      ]
    );
    ...
    const a = Tx.fromRaw(raw);
    console.log(a);
    assert.deepEqual(condition, a);
  });
});

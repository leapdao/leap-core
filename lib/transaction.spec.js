...
describe('transactions', () => {
  ...
  it('should allow to create and parse consolidate tx.', () => {
    ...
    // test hashing
    // expect(consolidate.sigHash()).to.eql(transferSigHash);
    // test signing
    // const consolidateHash = '0x96770cc96620c368f5b61581e4a271a79de4cd5b0ed95d0724996cd4097de262';
    consolidate.sigHash();
    consolidate.signAll(PRIV);
    // expect(consolidate.hash()).to.eql(consolidateHash);
    // test parse
    Tx.fromRaw(consolidate.hex()).sigHash();

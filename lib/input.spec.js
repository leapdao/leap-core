...
describe('Input', () => {
  ...
  it('should allow to parse spending condition input', () => {
    const inputBuf = Buffer.from('0d000000000754d4ec117777777777777777777777777777777777777777777777777777777777777777002e258a4ff440bc77f784792bbb3b3598709efd97198f1e59dc8f2c03ac20621d1783f9a1b58da8d00cbb8a58c12edc82725466f6421d3232369c236a4775f32b1c0001aa0002bbbb', 'hex');
    const sigHash = Buffer.from('64ee1fed7e68f8e68d48fb41f6f36cf6c4a313e2e66fbe636a4e48b840d9a690', 'hex');
    const input = Input.fromRaw(inputBuf, 10, sigHash, Type.SPEND_COND);
    assert.deepEqual(input.toJSON(), {
      hash: `0x${inputBuf.slice(10, 42).toString('hex')}`,
      index: 0,
      r: '0x2e258a4ff440bc77f784792bbb3b3598709efd97198f1e59dc8f2c03ac20621d',
    ...
    assert.equal(input.toRaw().toString('hex'), '7777777777777777777777777777777777777777777777777777777777777777002e258a4ff440bc77f784792bbb3b3598709efd97198f1e59dc8f2c03ac20621d1783f9a1b58da8d00cbb8a58c12edc82725466f6421d3232369c236a4775f32b1c0001aa0002bbbb');
  });

  it('should allow to parse spending condition input with no data', () => {
    const inputBuf = Buffer.from('0d000000000754d4ec117777777777777777777777777777777777777777777777777777777777777777012e258a4ff440bc77f784792bbb3b3598709efd97198f1e59dc8f2c03ac20621d1783f9a1b58da8d00cbb8a58c12edc82725466f6421d3232369c236a4775f32b1c00000000', 'hex');
    const sigHash = Buffer.from('64ee1fed7e68f8e68d48fb41f6f36cf6c4a313e2e66fbe636a4e48b840d9a690', 'hex');
    const input = Input.fromRaw(inputBuf, 10, sigHash, Type.SPEND_COND);
    assert.deepEqual(input.toJSON(), {
      hash: `0x${inputBuf.slice(10, 42).toString('hex')}`,
    ...
    assert.equal(input.toRaw().toString('hex'), '7777777777777777777777777777777777777777777777777777777777777777012e258a4ff440bc77f784792bbb3b3598709efd97198f1e59dc8f2c03ac20621d1783f9a1b58da8d00cbb8a58c12edc82725466f6421d3232369c236a4775f32b1c00000000');
  });
});

...
describe('Outpoint', () => {
  ...
  let out1;
  beforeEach(() => {
    tx1 = Buffer.from('', 'hex');
  ...
  it('should create an outpoint from JSON', () => {
    ...
    assert.deepEqual(out1, Outpoint.fromJSON(out1.toJSON()));
  });

  it('should create an outpoint from JSON', () => {
    const toJSON = out1.toJSON();

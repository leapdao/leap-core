...
describe('Output', () => {
  ...
  it('should allow to create output from json', () => {
    const output = new Output({ address: `0x${ADDR}`, value: 11 });
  ...
  it('should allow to decode from raw transfer', () => {
    const outputBuff = Buffer.from('0000000005e69ec082e8c6cf42c8d1ff9594b17a3f50e94a12cc860f', 'hex');
  ...
  it('should allow to decode from raw computation request output', () => {
    const outputBuff = Buffer.from('0000000005e69ec000000000001482e8c6cf42c8d1ff9594b17a3f50e94a12cc860f', 'hex');
  ...
  it('should allow to decode from raw computation response output', () => {
    const outputBuff = Buffer.from(`0000000005e69ec082e8c6cf42c8d1ff9594b17a3f50e94a12cc860f${ROOT}`, 'hex');
  ...
  it('should fail on invalid msgData length', () => {
    const outputBuff = Buffer.from('0000000005e69ec000000000002082e8c6cf42c8d1ff9594b17a3f50e94a12cc860f', 'hex');
  ...
  it('should allow to encode to raw computation request output', () => {
    ...
    assert.equal(
      output.toRaw().toString('hex'),
      `0000000005e69ec000970fe00014${ADDR}`,
    );
  });
  ...
  it('should allow to encode to short raw computation request output', () => {
    ...
    assert.equal(
      output.toRaw().toString('hex'),
      '0000000005e69ec000970fe000021234',
    );
  });

...
describe('Output', () => {
  ...
  it('should allow to decode from raw computation request output', () => {
    const outputBuff = Buffer.from('0000000005e69ec0053982e8c6cf42c8d1ff9594b17a3f50e94a12cc860f00000000001482e8c6cf42c8d1ff9594b17a3f50e94a12cc860f', 'hex');
  ...
  it('should allow to encode to raw computation request output', () => {
    ...
    assert.equal(
      output.toRaw().toString('hex'),
      `0000000005e69ec00539${ADDR}00970fe00014${ADDR}`,
    );
  });
  ...
  it('should allow to encode to short raw computation request output', () => {
    ...
    assert.equal(
      output.toRaw().toString('hex'),
      `0000000005e69ec00539${ADDR}00970fe000021234`,
    );
  });

...
export default class Output {
  ...
  static fromRaw(buf, offset = 0, isComp = 0) {
    ...
    const value = parseInt(buf.slice(offset, offset + 32).toString('hex'), 16);
  ...
  toRaw() {
    ...
    // console.log('to', this.value.toString(16).padStart(64, '0'));
    dataBuf.write(this.value.toString(16).padStart(64, '0'), 0, 32, 'hex');

...
describe('helpers', () => {
  ...
  describe('consolidateUTXOs', () => {
    ...
    it('consolidates < 15 utxos', () => {
      ...
      expect(consolidates[0].outputs[0].value).to.deep.eq(1000n);
    });
    ...
    it('consolidates === 15 utxos', () => {
      ...
      expect(consolidates[0].outputs[0].address).to.eq(ADDR_1);
      expect(consolidates[0].outputs[0].color).to.eq(0);
      expect(consolidates[0].outputs[0].value).to.deep.eq(1500n);
    });
    ...
    it('consolidates > 15 utxos', () => {
      ...
      expect(consolidates[1].outputs[0].value).to.deep.eq(500n);
    });
